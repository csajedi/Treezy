...
async function main() {
    ...
    privkey = '07e0b1d1870a0ba1b60311323cb9c198d6f6193b2219381c189afab3f5ac41a9'; //zil12qd8pll250e3c89vec68ne68zd2xh2jyccregx
    ...
    console.log("start to deploy the anchor contract: ");
    const code = fs.readFileSync("Anchor.scilla").toString();
